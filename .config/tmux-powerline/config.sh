...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/axel/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/axel/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	export TMUX_POWERLINE_SEG_NOW_PLAYING_MAX_LEN="150"
	...
	export TMUX_POWERLINE_SEG_NOW_PLAYING_ROLL_MODE="space"
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/axel/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/Users/axel/.tmux/plugins//tmux-continuum"
# }
...
# vcs_branch.sh {
	...
	export TMUX_POWERLINE_SEG_VCS_BRANCH_MAX_LEN="100"
